<nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent" style="background: #8a3939">
    <div class="container-fluid">
      <h1 style="color:white; padding-left:120px"> Panel Admin</h1>
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown nav-item">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <div class="photo">
                            <img    src="{{ asset('/public/image/avatars/' .auth()->guard()->user()->avatar) }}"     class="avatar"  alt="{{ __('Profile Photo') }}">
                        </div>
                    ...
                    <ul class="dropdown-menu dropdown-navbar">
                        <li class="nav-link">
                            <a href="{{ route('admin.profile.profile')  }}" class="nav-item dropdown-item">{{ __('Profile') }}</a>
                        </li>
                        <li class="nav-link">
